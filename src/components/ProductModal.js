                ...
                <div className="p-6">
                    {loading ? (
                        ...
                        <div className="text-center text-gray-400 py-12">
                            ...
                            <p className="text-sm mt-2">Verwenden Sie das Admin Panel, um Produktbilder für {category.title} hinzuzufügen.</p>
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            {products.map((p, i) => (
                                <div key={i} className="bg-zinc-800 p-3 rounded-lg">
                                    <img src={p.image} alt="product" className="rounded mb-2 w-full h-40 object-cover" />
